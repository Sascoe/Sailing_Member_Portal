...
export default function MemberSignupPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      // Create users/{uid} first — members/{uid}'s create rule checks that
      // this doc's role is already "member".
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-white">
      ...
      >
        <h1 className="text-2xl font-bold text-center text-purple-600">Create member account</h1>
        <p className="text-center text-sm text-slate-600">
          For existing club members setting up their account. If you're a prospie going through
          recruitment, use the regular sign up page instead.
        </p>
        ...
        <label className="block">
          ...
          <div className="mt-1 text-xs text-slate-500">
            This photo shows up next to your evaluations, so other members can tell who rated a prospie.
          </div>
        </label>
